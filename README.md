...
## O projektu
Omejila sem se na kategorijo mesnih jedi, ki vsebuje približno 1600 receptov. Od vsakega recepta sem uporabila naslednje podatke: ime jedi, avtor, vrsta, èas priprave, zahtevnost, število porcij in datum objave. Vsebina vseh receptov ni popolna, saj nekateri podatki manjkajo ali pa so zapisani nestrukturirano in bi jih bilo težko vkljuèili v analizo.
Ugotavljala sem porazdelitev števila receptov po letih, najpogostejše vrste jedi, najaktivnejše avtorje, povezave med zahtevnostjo, številom porcij, èasom priprave in vrsto ter preverila, èe iz imena jedi lahko napovemo vrsto.
